...
main(void)
{
  ...
  msgctl(mid, IPC_STAT, &buf); // message control on the flag we will give it *IPC_STAT* for stats
  ...
  msgctl(mid, IPC_RMID, (struct msqid_ds *) 0); // to delete the message queue
